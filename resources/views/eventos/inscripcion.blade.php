...
<body class="min-h-screen bg-[radial-gradient(circle_at_top,_#fef3c7,_#f5f5f4_42%,_#fafaf9_100%)] text-stone-900">
    <div class="mx-auto max-w-4xl px-4 py-12">
        <div class="overflow-hidden rounded-[2rem] border border-stone-200 bg-white shadow-sm">
            <div class="border-b border-stone-200 bg-stone-50 px-8 py-8">
                <p class="text-sm font-semibold uppercase tracking-[0.22em] text-amber-700">Inscripción</p>
                <h1 class="mt-2 text-3xl font-semibold text-stone-950">{{ $eventoFecha->evento->nombre }}</h1>
                <div class="mt-4 flex flex-wrap gap-4 text-sm text-stone-600">
                    <span class="rounded-full bg-white px-4 py-2 ring-1 ring-stone-200">
            ...
            <div class="px-8 py-8">
                ...
                <div class="mb-8 rounded-2xl border border-stone-200 bg-stone-50 px-5 py-4 text-sm text-stone-600">
                ...
                <form method="POST" action="{{ route('eventos.inscripcion.store', $eventoFecha) }}" class="space-y-6">
                    ...
                    <div class="grid gap-5 md:grid-cols-2">
                        <label class="block">
                            <span class="mb-2 block text-sm font-medium text-stone-700">Nombre</span>
                            <input
                                name="nombre"
                        ...
                        <label class="block">
                            <span class="mb-2 block text-sm font-medium text-stone-700">Apellido</span>
                            <input
                                name="apellido"
                        ...
                        <label class="block">
                            <span class="mb-2 block text-sm font-medium text-stone-700">Fecha de nacimiento</span>
                            <input
                                type="date"
                        ...
                        <label class="block">
                            <span class="mb-2 block text-sm font-medium text-stone-700">Teléfono</span>
                            <input
                                name="telefono"
                        ...
                        <label class="block md:col-span-2">
                            <span class="mb-2 block text-sm font-medium text-stone-700">Departamento</span>
                            <select
                                name="departamento"
                                class="w-full rounded-2xl border border-stone-300 px-4 py-3"
                            >
                    ...
                    <div class="flex flex-wrap gap-3">
                        <button class="rounded-full bg-stone-950 px-6 py-3 text-sm font-medium text-white">
                            Continuar
                        </button>
                    </div>
                </form>
    ...
    @if ($candidates->isNotEmpty())
        <div id="candidate-modal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/45 px-4 py-8">
            <div class="max-h-full w-full max-w-4xl overflow-y-auto rounded-[2rem] bg-white p-8 shadow-2xl">
                <p class="text-sm font-semibold uppercase tracking-[0.22em] text-amber-700">Posibles coincidencias</p>
                <h2 class="mt-2 text-2xl font-semibold text-stone-950">Encontramos personas parecidas</h2>
                        ...
                        <div class="rounded-3xl border border-stone-200 bg-stone-50 p-5">
                            <div class="flex flex-wrap items-start justify-between gap-4">
                                <div>
                                    ...
                                    <div class="mt-2 grid gap-2 text-sm text-stone-600 md:grid-cols-2">
                                ...
                                <form method="POST" action="{{ route('eventos.inscripcion.store', $eventoFecha) }}">
                                    ...
                                    <button class="rounded-full bg-emerald-700 px-5 py-3 text-sm font-medium text-white">
                                        Sí, soy esta persona
                                    </button>
                                </form>
                            </div>
                ...
                <div class="mt-6 flex flex-wrap gap-3">
                    <form method="POST" action="{{ route('eventos.inscripcion.store', $eventoFecha) }}">
                        ...
                        <button class="rounded-full border border-stone-300 px-5 py-3 text-sm font-medium text-stone-800">
                    ...
                    <button
                        ...
                        class="rounded-full border border-transparent px-5 py-3 text-sm font-medium text-stone-500"
                    >
