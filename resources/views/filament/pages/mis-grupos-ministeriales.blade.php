        ...
        <div class="rounded-3xl border border-gray-200 bg-white shadow-sm">
            <div class="px-4 py-6">
                <div class="flex flex-wrap items-center justify-between gap-4">
                    <div>
                        <h2 class="text-lg font-semibold text-gray-900">Grupos ministeriales liderados</h2>
                ...
                <div class="mt-6 overflow-x-auto px-10 pb-6">
                    <table class="min-w-full divide-y divide-gray-200 text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @foreach ($rows as $row)
                                <tr>
                                    <td class="px-4 py-4 font-medium text-gray-800">{{ $row['grupo']->nombre }}</td>
                                    <td class="px-4 py-4 text-gray-600">{{ $row['grupo']->tipoGrupo?->nombre ?? '-' }}</td>
                                    <td class="px-4 py-4 text-gray-700">{{ $row['integrantes_activos'] }}</td>
                                    <td class="px-4 py-4 text-emerald-700">{{ $row['en_crecimiento'] }}</td>
                                    <td class="px-4 py-4 text-amber-700">{{ $row['sin_crecimiento'] }}</td>
